...
export const ViewUserModal = ({ isOpen, onClose, onSave, userId }) => {
  ...
  // Predefined interests - could be made dynamic in the future
  const interests = [
    "Pottery",
    "Hiking",
    "Swimming",
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await onSave(user.alumni_id, formData);
      setIsEditing(false);
    } catch (error) {
    ...
    >
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          {/* Green header with user icon */}
          <div
            className="modal-header"
            style={{
              backgroundColor: "#4a7c1b",
              color: "white",
              padding: "15px 20px",
            }}
          >
            <div className="d-flex align-items-center">
              ...
              <h5 className="modal-title mb-0" style={{ fontWeight: "400" }}>
                {isEditing ? "Edit User's Profile" : "View User's Profile"}
              </h5>
            </div>
            <button
              type="button"
          ...
          <div className="modal-body p-0">
            <div className="row g-0">
              {/* Left column with profile info and interests */}
              <div
                className="col-md-5"
                ...
                {loading ? (
                  ...
                  <>
                    ...
                    <div className="text-center">
                      <div
                        className="rounded-circle overflow-hidden mb-3 mx-auto"
                        style={{
                          width: "200px",
                          height: "200px",
